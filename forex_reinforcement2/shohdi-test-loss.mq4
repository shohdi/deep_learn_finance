...
void OnDeinit(const int reason)
  {
      ...
      calcSuccessToFailOrders();
       Print("no of success : " + noOfSuccess + " , no of fail : " + noOfFail);
        ...
        Print("Total Steps : " , totalSteps , " done count : ",doneCount," average steps : " , totalSteps/doneCount);
...
//--- 
...

  {
    ...
    string cookie=NULL,headers;
            ...
            res=0; //WebRequest("GET",myUrl,cookie,NULL,590000,post,0,result,headers);
            started = true;
            string webRet = "";
